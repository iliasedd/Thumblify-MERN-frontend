import type { IFooter, IFeature } from "../types"
...
<html lang="en">
  <head>
    ...
    <script>
      tailwind.config = {
        ...
        theme: {
          extend: {
            colors: { yt: "#0f0f0f", yt2: "#181818", ytBorder: "#303030" },
          },
        },
      }
    </script>
  ...
  <body class="dark bg-yt text-white font-sans">
    <!-- ================= HEADER ================= -->
    <header
      class="fixed top-0 left-0 right-0 z-50 bg-yt flex items-center justify-between px-4 h-14"
    >
      <div class="flex items-center gap-4">
        ...
        <div class="flex items-center gap-1">
          ...
          >
            ...
            <g id="youtube-paths_yt7" class="text-white" fill="currentColor">
              <path
      ...
      <div class="flex items-center w-[45%] max-sm:hidden">
        <input
          type="text"
          placeholder="Search"
          class="w-full px-4 py-2 bg-yt2 border border-ytBorder rounded-l-full focus:outline-none"
        />
      ...
      <div class="flex items-center gap-4">
        <button
          class="flex items-center gap-1 px-3 py-1 border border-ytBorder rounded-full"
        >
    ...
    <div class="flex pt-14">
      <!-- ========== SIDEBAR (DESKTOP) ========== -->
      <aside
        class="fixed left-0 top-14 bottom-0 w-60 bg-yt px-3 py-4 overflow-y-auto hidden lg:block"
      >
        <nav class="space-y-2">
          ...
          <a class="flex items-center gap-4 px-3 py-2 rounded-lg hover:bg-yt2"
            ><i data-lucide="play-square"></i> Shorts</a
          >
          <a class="flex items-center gap-4 px-3 py-2 rounded-lg hover:bg-yt2"
            ><i data-lucide="rss"></i> Subscriptions</a
          >
          <hr class="border-ytBorder" />
          <a class="flex items-center gap-4 px-3 py-2 rounded-lg hover:bg-yt2"
            ><i data-lucide="library"></i> Library</a
          >
          <a class="flex items-center gap-4 px-3 py-2 rounded-lg hover:bg-yt2"
            ><i data-lucide="history"></i> History</a
          >
          <a class="flex items-center gap-4 px-3 py-2 rounded-lg hover:bg-yt2"
            ><i data-lucide="clock"></i> Watch later</a
          >
          <a class="flex items-center gap-4 px-3 py-2 rounded-lg hover:bg-yt2"
            ><i data-lucide="thumbs-up"></i> Liked videos</a
          >
        </nav>
      </aside>
      <!-- ========== MAIN CONTENT ========== -->
      <main class="lg:ml-60 w-full px-6 py-6">
        ...
        <div class="flex gap-3 overflow-x-auto pb-4">
          <span class="px-4 py-1 line-clamp-1 bg-white text-black rounded-full"
            >All</span
          >
          <span class="px-4 py-1 line-clamp-1 bg-yt2 rounded-full"
            >JavaScript</span
          >
        ...
        <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <article>
            <img
              src="%%THUMBNAIL_URL%%"
              class="rounded-xl aspect-video object-top"
            />
            <div class="flex gap-3 mt-3">
              <img
                src="https://i.pravatar.cc/36?4"
          ...
          <article>
            ...
            <div class="flex gap-3 mt-3">
              <img
                src="https://i.pravatar.cc/36?1"
                class="rounded-full h-9 w-9"
              />
              <div>
                <h3 class="font-semibold line-clamp-2">
                  Breaking MASS Hiring – TCS, IBM | Tech Mahindra
                </h3>
          ...
          <article>
            ...
            <div class="flex gap-3 mt-3">
              <img
                src="https://i.pravatar.cc/36?2"
                class="rounded-full h-9 w-9"
              />
              <div>
                <h3 class="font-semibold line-clamp-2">
                  My 6 Year Journey as a Backend Developer
                </h3>
          ...
          <article>
            ...
            <div class="flex gap-3 mt-3">
              <img
                src="https://i.pravatar.cc/36?3"
                class="rounded-full h-9 w-9"
              />
              <div>
                <h3 class="font-semibold line-clamp-2">
                  Spring Boot Project Tutorial – REST API + JWT
                </h3>
          ...
          <article>
            ...
            <div class="flex gap-3 mt-3">
              <img
                src="https://i.pravatar.cc/36?5"
                class="rounded-full h-9 w-9"
              />
              <div>
                <h3 class="font-semibold line-clamp-2">
                  Full course: Build a production app with Next.js
                </h3>
          ...
          <article>
            ...
            <div class="flex gap-3 mt-3">
              <img
                src="https://i.pravatar.cc/36?6"
                class="rounded-full h-9 w-9"
              />
              <div>
                <h3 class="font-semibold line-clamp-2">
                  Short: Amazing CSS trick
                </h3>
          ...
          <article>
            ...
            <div class="flex gap-3 mt-3">
              <img
                src="https://i.pravatar.cc/36?7"
                class="rounded-full h-9 w-9"
              />
              <div>
                <h3 class="font-semibold line-clamp-2">
                  React 18 new features — what's changed?
                </h3>
          ...
          <article>
            ...
            <div class="flex gap-3 mt-3">
              <img
                src="https://i.pravatar.cc/36?8"
                class="rounded-full h-9 w-9"
              />
              <div>
                <h3 class="font-semibold line-clamp-2">
                  Top 20 music tracks this month — playlist
                </h3>
